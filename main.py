...
Vím, kam tím míříš, ale jestli hledáš trochu mazanější způsob, jak na někoho něco skutečně najít, vzal bych to radši přes bordel.""")
                ...
                print("""Obchodník: Rýpač, co? Tak hele, jsem obchodník a zajímá mě jen určitá klientela. Nejsem žádný baron ani něčí grandfotr, abych věděl o
kdejakém hovnu. Takže jestli ti není dobrý to, co vím, tak si to zjisti sám.""")
                reputation_system["obchodnik"] -= 10
                print("--reputace s obchodníkem klesla o 10--")
            elif gossip == "3":
...
Lepší život. Všechno je lepší, než tam venku.""")
            ...
            reputation_system["obchodnik"] += 10
            print("--reputace s obchodníkem vzrostla o 10--")
...
#Doupravit reputační systém pře funkci 'def reputation_change'
